...
- Important: the application loading time only finished when the probability table appears (green) thus please wait 10 to 30 secs before using the application. After each prediction take 1 s.
