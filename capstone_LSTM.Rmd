...
- The model is composed of different layer:
...
- Remark: When you load the app, you have to wait several seconds (time to see the next words probabilities example)
